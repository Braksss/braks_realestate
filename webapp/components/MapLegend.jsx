...
export function MapLegend({ range, activeLayer }) {
  ...
  const legendInfo = {
    opportunityIndex: { title: "Indice d'Opportunité", unit: '', gradient: 'bg-gradient-to-r from-blue-500 to-red-600' },
    prixMoyenM2: { title: "Prix au m²", unit: '€', gradient: 'bg-gradient-to-r from-blue-500 to-red-600' },
  ...
  return (
    <div className="absolute bottom-4 right-4 z-[1000] bg-white/80 backdrop-blur-md p-3 rounded-lg shadow-lg w-56">
