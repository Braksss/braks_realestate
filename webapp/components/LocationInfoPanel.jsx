...
// Sous-composant pour afficher une barre de données comparative
const DataBar = ({ label, value, average, unit = '' }) => {
    // Détermine si la valeur est "bonne" (en dessous de la moyenne pour le prix, au-dessus pour l'évolution)
    const isFavorable = label.includes('Prix') ? value < average : value > average;
    
    // Calcule la largeur de la barre, plafonnée à 100%
    ...
    return (
        <div>
            ...
            <div className="w-full bg-gray-200 rounded-full h-2 relative group">
                ...
                ></div>
                {/* La ligne pointillée représentant la moyenne */}
                <div 
